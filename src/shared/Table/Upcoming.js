...
function Upcoming({ childAddAppointment, searchText, searchTermFromUpcoming }) {
  ...
  return (
    <>
      <div className=" w-[100%]  overflow-y-auto h-[200px] hidden md:flex items-center flex-col  ">
      ...
      <div className=" w-[100%]  overflow-y-auto h-[200px]   md:hidden items-center flex-col  ">
        <table className="w-full ">
          <thead className="border ">
            <tr className=" h-[50px] text-[13px]   md:text-[15px] bg-[#E2F2FA] ">
              <th className="font-man  font-medium w-[25%] md:w-[20%]">Name</th>
      ...
      <div className=" w-[100%]  overflow-y-auto h-[180px]  md:hidden items-center flex-col  ">
        <table className="w-full ">
          <thead
            className="
           "
      ...
      <div className=" w-[100%]  overflow-y-auto h-[200px]  hidden md:flex items-center flex-col  ">
        <table className="w-full ">
          <thead className=" ">
            <tr className="border-l invisible text-[13px]   md:text-[15px] bg-[#E2F2FA] ">
              <th className="font-man  first-letter: font-medium px-4 w-[5%] md:w-[3%] ">
                ID
              </th>
              <th className="font-man  font-medium w-[25%] md:w-[20%]">Name</th>
